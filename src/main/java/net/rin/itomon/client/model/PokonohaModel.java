...
public class PokonohaModel<T extends Entity> extends AbstractItomonModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("itomon", "pokonoha_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(20, 42).addBox(-5.0F, -12.0F, -7.0F, 10.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(4, 0).addBox(-0.5F, -7.6022F, 4.2235F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		leaf.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(6, 11).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -8.0F, -7.0F, 0.0F, 0.0F, -0.3927F));
		leaf.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 11).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -8.0F, -7.0F, 0.0F, 0.0F, 0.3927F));
		partdefinition.addOrReplaceChild(
						"leg_f_r", CubeListBuilder.create().texOffs(0, 5).addBox(-5.0F, -2.0F, -6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(6, 5).addBox(-4.5F, -0.5F, -5.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
						PartPose.offset(1.0F, 24.0F, 0.0F));
		partdefinition.addOrReplaceChild(
						"leg_f_l", CubeListBuilder.create().texOffs(0, 5).addBox(-5.0F, -2.0F, -6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(6, 5).addBox(-4.5F, -0.5F, -5.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
						PartPose.offset(7.0F, 24.0F, 0.0F));
		partdefinition.addOrReplaceChild(
						"leg_b_l", CubeListBuilder.create().texOffs(0, 5).addBox(-5.0F, -2.0F, -6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(6, 5).addBox(-4.5F, -0.5F, -5.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
						PartPose.offset(7.0F, 24.0F, 8.0F));
		partdefinition.addOrReplaceChild(
						"leg_b_r", CubeListBuilder.create().texOffs(0, 5).addBox(-5.0F, -2.0F, -6.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(6, 5).addBox(-4.5F, -0.5F, -5.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
