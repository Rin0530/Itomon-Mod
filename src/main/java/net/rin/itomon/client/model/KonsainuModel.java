...
public class KonsainuModel<T extends Entity> extends AbstractItomonModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "konsainu"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(54, 52)
						.addBox(-5.0F, -8.9946F, -8.0F, 10.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
						...
						.texOffs(3, 120).addBox(-2.0F, -7.3978F, 6.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		body.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(3, 123)
						.addBox(-2.0F, -0.3978F, -1.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(14, 115).addBox(-0.3978F, -2.0F, -1.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 8.0F, 0.0F, 0.0F, 0.3927F));

		body.addOrReplaceChild("hexadecagon_r2",
				CubeListBuilder.create().texOffs(3, 116)
						.addBox(-2.0F, -0.3978F, -1.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(18, 121).addBox(-0.3978F, -2.0F, -1.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 8.0F, 0.0F, 0.0F, -0.3927F));

		body.addOrReplaceChild(
				"hexadecagon_r3", CubeListBuilder.create().texOffs(14, 121).addBox(-0.3978F, -2.0F, -1.5F, 0.0F, 4.0F,
						1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 8.0F, 0.0F, 0.0F, 0.7854F));

		body.addOrReplaceChild("hexadecagon_r4",
				CubeListBuilder.create().texOffs(18, 115).addBox(-0.3978F, -2.0F, -1.5F, 0.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 8.0F, 0.0F, 0.0F, -0.7854F));

		body.addOrReplaceChild("hexadecagon_r5",
				CubeListBuilder.create().texOffs(28, 125)
						.addBox(-1.0F, -0.1989F, -1.5F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(36, 111).addBox(-0.1989F, -1.0F, -1.5F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.0F, 9.0F, 0.0F, 0.0F, 0.3927F));

		body.addOrReplaceChild("hexadecagon_r6",
				CubeListBuilder.create().texOffs(34, 121)
						.addBox(-1.0F, -0.1989F, -1.5F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(30, 115).addBox(-0.1989F, -1.0F, -1.5F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.0F, 9.0F, 0.0F, 0.0F, -0.3927F));

		body.addOrReplaceChild(
				"hexadecagon_r7", CubeListBuilder.create().texOffs(36, 115).addBox(-0.1989F, -1.0F, -1.5F, 0.0F, 2.0F,
						2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.0F, 9.0F, 0.0F, 0.0F, 0.7854F));

		body.addOrReplaceChild("hexadecagon_r8",
				CubeListBuilder.create().texOffs(30, 111).addBox(-0.1989F, -1.0F, -1.5F, 0.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -6.0F, 9.0F, 0.0F, 0.0F, -0.7854F));

		body.addOrReplaceChild("hexadecagon_r9",
				CubeListBuilder.create().texOffs(70, 108)
						.addBox(-0.6962F, -3.5F, -1.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
						...
						.texOffs(41, 0).addBox(-0.9946F, -5.0F, 1.0F, 1.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, -9.0F, 0.0F, 0.0F, -0.3927F));

		body.addOrReplaceChild("hexadecagon_r10",
				CubeListBuilder.create().texOffs(56, 103)
						.addBox(-0.6962F, -3.5F, -1.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
						...
						.texOffs(43, 119).addBox(-3.5F, -0.6962F, -1.0F, 7.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, -9.0F, 0.0F, 0.0F, 0.3927F));

		body.addOrReplaceChild("hexadecagon_r11",
				CubeListBuilder.create().texOffs(70, 120)
						.addBox(-0.6962F, -3.5F, -1.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
						...
						.texOffs(110, 0).addBox(-0.9946F, -5.0F, 1.0F, 1.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, -9.0F, 0.0F, 0.0F, 0.7854F));

		body.addOrReplaceChild("hexadecagon_r12",
				CubeListBuilder.create().texOffs(39, 102).addBox(-0.5967F, -3.0F, -1.5F, 1.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.5F, 5.0F, 0.0F, 0.0F, -0.7854F));

		body.addOrReplaceChild("hexadecagon_r13",
				CubeListBuilder.create().texOffs(49, 89)
						.addBox(-0.5967F, -3.0F, -1.5F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(4, 91).addBox(-3.0F, -0.5967F, -1.5F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.5F, 5.0F, 0.0F, 0.0F, -0.3927F));

		body.addOrReplaceChild("hexadecagon_r14",
				CubeListBuilder.create().texOffs(39, 89)
						.addBox(-0.5967F, -3.0F, -1.5F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(4, 107).addBox(-3.0F, -0.5967F, -1.5F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.5F, 5.0F, 0.0F, 0.0F, 0.3927F));

		body.addOrReplaceChild(
				"hexadecagon_r15", CubeListBuilder.create().texOffs(27, 102).addBox(-0.5967F, -3.0F, -1.5F, 1.0F, 6.0F,
						3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.5F, 5.0F, 0.0F, 0.0F, 0.7854F));

		body.addOrReplaceChild("hexadecagon_r16",
				CubeListBuilder.create().texOffs(28, 40)
						.addBox(-0.8951F, -4.5F, -8.0F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.0F))
						...
						.texOffs(63, 120).addBox(-0.6962F, -3.5F, -18.0F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, 8.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition leg_f_r = partdefinition.addOrReplaceChild("leg_f_r", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		leg_f_r.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(-3.0F, 1.5F, -14.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.0F, -0.424F, 0.091F, 0.1986F));

		PartDefinition leg_f_l = partdefinition.addOrReplaceChild("leg_f_l", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		leg_f_l.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(2.0F, 1.5F, -14.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 5.0F, -0.424F, -0.091F, -0.1986F));

		PartDefinition leg_b_l = partdefinition.addOrReplaceChild("leg_b_l", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		leg_b_l.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(4.0F, -2.0F, 1.0F, 0.3618F, -0.0741F, -0.3414F));

		PartDefinition leg_b_r = partdefinition.addOrReplaceChild("leg_b_r", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		leg_b_r.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 3.0F, 2.0F,
						new CubeDeformation(-0.5F)),
				PartPose.offsetAndRotation(-4.0F, -2.0F, 1.0F, 0.3618F, -0.0741F, 0.3414F));

		partdefinition.addOrReplaceChild("leaf",
				CubeListBuilder.create().texOffs(91, 66)
						.addBox(-1.0F, -14.5F, -5.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
						...
						.texOffs(101, 72).addBox(-6.0F, -14.5F, -5.0F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition ear_r = partdefinition.addOrReplaceChild("ear_r", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		ear_r.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(-3.0F, 1.5F, -14.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(2.0F, -5.0F, 3.0F, -0.2582F, 0.4012F, 0.5013F));

		PartDefinition ear_l = partdefinition.addOrReplaceChild("ear_l", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		ear_l.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 0).addBox(2.0F, 1.5F, -14.0F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -5.0F, 3.0F, -0.2582F, -0.4012F, -0.5013F));
