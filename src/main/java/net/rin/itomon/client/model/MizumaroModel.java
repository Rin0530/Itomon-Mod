...
public class MizumaroModel<T extends Entity> extends AbstractItomonModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("itomon", "mizumaro_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(6, 1).addBox(-1.0F, 0.5609F, 0.2618F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 17.0822F, 3.7715F, 0.1745F, 0.0F, 0.0F));
		tail.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(12, 4).addBox(1.5F, 1.7816F, 2.647F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 4)
		...
		partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 11).mirror().addBox(-3.0F, -9.0F, -4.0F, 6.0F, 6.0F, 7.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(16, 5).mirror().addBox(-2.0F, -8.0F, 3.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 0).addBox(-2.0F, -12.0F, -2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(1.0F, -12.0F, -2.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		partdefinition.addOrReplaceChild("leg_f_r",
				CubeListBuilder.create().texOffs(4, 0).addBox(-2.5F, -3.0F, -3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		partdefinition.addOrReplaceChild("leg_f_l",
				CubeListBuilder.create().texOffs(4, 0).addBox(1.5F, -3.0F, -3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		partdefinition.addOrReplaceChild("leg_b_l",
				CubeListBuilder.create().texOffs(4, 0).addBox(1.5F, -3.0F, 1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		partdefinition.addOrReplaceChild("leg_b_r",
				CubeListBuilder.create().texOffs(4, 0).addBox(-2.5F, -3.0F, 1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
