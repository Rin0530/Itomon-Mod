...
public class ItomonModItems {
	public static final DeferredRegister<Item> REGISTRY = DeferredRegister.create(ForgeRegistries.ITEMS, ItomonMod.MODID);
	public static final RegistryObject<Item> TUMURISU = REGISTRY.register("tumurisu_spawn_egg",
			() -> new ForgeSpawnEggItem(ItomonModEntities.TUMURISU, -52225, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MIZUMARO = REGISTRY.register("mizumaro_spawn_egg",
			() -> new ForgeSpawnEggItem(ItomonModEntities.MIZUMARO, -16711681, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> POKONOHA = REGISTRY.register("pokonoha_spawn_egg",
			() -> new ForgeSpawnEggItem(ItomonModEntities.POKONOHA, -16738048, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
